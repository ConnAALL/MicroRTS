...
public class Network extends Neat {
	...
	public void setInputs(Vector<NNode> inputs) {
		this.inputs = inputs;
	}

	public Vector<NNode> getOutputs() {
		return outputs;
	}

	public void setOutputs(Vector<NNode> outputs) {
		this.outputs = outputs;
	}

	public Vector<NNode> getAllnodes() {
		return allnodes;
	}

	public void setAllnodes(Vector<NNode> allnodes) {
	 ...
	 */
	public Network(Vector<NNode> in, Vector<NNode> out, Vector<NNode> all, int xnet_id) {
		inputs = in;
		outputs = out;
		allnodes = all;
		name = null;
		...
		while (!done) {
			...
			if (!outputsoff()) {
				...
				if (!has_changed) {
					...
					// of no change....
					counter_stable += 1;
					// if counter no change >= 'period' parameter (virtual depth) , the net is
					// relaxed
