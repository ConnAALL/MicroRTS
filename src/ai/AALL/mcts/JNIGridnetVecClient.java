...
public class JNIGridnetVecClient {
    ...
    public JNIGridnetVecClient(int a_num_selfplayenvs, int a_num_envs, int a_max_steps, RewardFunctionInterface[] a_rfs, String a_micrortsPath, String[] a_mapPaths, 
        ...
        for (int i = 0; i < clients.length; i++) {
            ...
            System.out.println(a_rfs);
            System.out.println(a_micrortsPath);
            System.out.println(mapPaths[a_num_selfplayenvs + i]);
            System.out.println(a_ai2s[i]);
            System.out.println(a_utt);
            System.out.println(partialObs);
