...
public class vectTableModel extends AbstractTableModel {
	...
	public Vector<ParamValue> data;
	public int rows;

	public static final String columnNames[] = { " Parameter ", " Value " };

	public vectTableModel(Vector<ParamValue> _data) {
		data = _data;
		rows = -1;
	}
			...
			case 1: {
...

				{
					...
					if (s1.o2 instanceof Integer) {
						...
						ox = Integer.valueOf(value.toString());  // Use valueOf instead of the constructor
					} else if (s1.o2 instanceof Double) {
						// System.out.print(" double ");
						ox = Double.valueOf(value.toString());   // Use valueOf instead of the constructor
					}
				}
				s1.o2 = (Object) ox;
